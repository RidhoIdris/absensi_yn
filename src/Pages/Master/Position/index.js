...
class Position extends Component {
  ...
  getData = debounce(() => {
    axios({
      methos : 'GET',
      url: `${this.props.base_api_url}position${this.state.parameter}`,
      headers: {
  ...
  handleDelete = (data) => {
    Swal.fire({
        ...
        if (result.value) {
            axios({
                method: 'DELETE',
                url: this.props.base_api_url+'position',
                data    : {
                    id: data.id,
                },
                headers: {
  ...
  handleSubmit = (e) => {
    ...
    let url;
    if (this.state.edit) {
        url = this.props.base_api_url+'position/'+this.state.id;
    }else{
        url =  this.props.base_api_url+'position';
    }
    axios({
    ...
    .then(response=>{
        ...
        Toast.fire({
            icon: 'success',
            title: this.state.edit ? 'Position Updated' : 'Position Created'
        });
